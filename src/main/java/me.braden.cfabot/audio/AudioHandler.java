...
import me.braden.cfabot.queue.FairQueue;
...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler 
{
    ...
    public Message getNowPlaying(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            eb.setDescription((audioPlayer.isPaused() ? CFABot.PAUSE_EMOJI : CFABot.PLAY_EMOJI)
    ...
    public Message getNoMusicPlaying(JDA jda)
    {
        ...
        return new MessageBuilder()
                ...
                .setDescription(CFABot.STOP_EMOJI+" "+FormatUtil.progressBar(-1)+" "+FormatUtil.volumeIcon(audioPlayer.getVolume()))
    ...
    public String getTopicFormat(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            return "**"+title+"** ["+(userid==0 ? "autoplay" : "<@"+userid+">")+"]"
                    + "\n" + (audioPlayer.isPaused() ? CFABot.PAUSE_EMOJI : CFABot.PLAY_EMOJI) + " "
                    + "[" + FormatUtil.formatTime(track.getDuration()) + "] "
                    + FormatUtil.volumeIcon(audioPlayer.getVolume());
        }
        else return "No music playing " + CFABot.STOP_EMOJI + " " + FormatUtil.volumeIcon(audioPlayer.getVolume());
    }
